...
const buttonVariants = cva(
  " !py-5 !px-2 cursor-pointer inline-flex items-center" +
    ...
    "aria-invalid:border-destructive !text-sm",
  {
    variants: {
      variant: {
        default:
          " bg-gradient-to-r from-red-500 to-rose-400 text-primary-foreground shadow-xs hover:bg-primary/90",
        destructive:
